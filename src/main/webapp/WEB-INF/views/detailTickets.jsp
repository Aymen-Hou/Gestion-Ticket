...
<div class="marginSolution" >
<button type="submit"  class="btn btn-primary" id="reload" >
<span class="glyphicon glyphicon-plus"></span> Apporter Une Solution</button>
</div>
...
<table class="table table-striped" >
		...
		<td>${ticket.produit.serialNumber}</td>
	    </tr>
	    
	    <tr>
		<td>Déscription du Probléme</td>
		<td>${ticket.description}</td>
	    </tr>
	    
	    <tr>
		<td>Statut</td>
		<td>${ticket.statut.nameStatut}</td>
	    </tr>
	    
	    <tr>
		<td>Priorité</td>
		<td>${ticket.priorite.namePrio}</td>
	    </tr>
