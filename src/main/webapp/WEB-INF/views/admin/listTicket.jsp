...
<script src="<c:url value="/resources/js/commentAdmin.js" />"></script>
...
<c:forEach items="${tickets}" var="p"> 
	<tr>
		...
		<td>${p.solution}</td>
		<td><a class="info btn btn-info" data-id="${p.idTicket}" href="javascript:void(0)"><span class="glyphicon glyphicon-plus-sign"></span> Add a Comment</a></td>
		<td><a href="pdf?idTick=${p.idTicket}" class="btn btn-danger"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> PDF</a></td>
